...
<p>This is the web site of <strong><?php echo "$companyName" ?></strong>.</p>

<p>We can be reached via e-mail at <a href="mailto:<?php echo "$companyEmail" ?>"><?php echo "$companyEmail" ?></a> or you can reach Mr Vindlas secretary by telephone at <?php echo "$phonenumber" ?>.</p>
