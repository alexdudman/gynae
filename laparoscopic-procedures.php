<?php 
	...
	$messageBar = "Specialist in Laparoscopic Procedures in Nottingham. Professional, Discreet and Empathic";
	...
	<div id="container">
        ...
        <?php include ("includes/content/sidebar.php"); ?>
			...
			<div id="main">
				...
				<h1>Laparoscopic Procedures</h1>
                
                <img src="images/layout/one.jpg" />
				
				<p>Mr Vindla performs many procedures through keyhole surgery. These include the treatment of endometriosis, the treatment of ovarian cysts, surgery on Fallopian tubes to improve fertility, the treatment of scar tissue in the pelvis and also to perform a laparoscopic hysterectomy where the cervix may or may not be left behind.
</p>
